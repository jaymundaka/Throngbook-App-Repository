...
?>
<div class="contact<?php echo $this->pageclass_sfx?> clearfix">
...
<?php endif; ?>
	...
	<?php if ($this->params->get('presentation_style')=='plain'):?>
		<?php  echo '<div class="contact-info-wrap"><h3>'. JText::_('COM_CONTACT_DETAILS').'</h3>';  ?>
	<?php endif; ?>
	...
	<?php if ($this->params->get('show_email_form') && ($this->contact->email_to || $this->contact->user_id)) : ?>
		...
		<?php endif; ?>
		<?php if ($this->params->get('presentation_style')=='plain'):?>
			<?php  echo '<div class="contact-form-wrap"><h3>'. JText::_('COM_CONTACT_EMAIL_FORM').'</h3>';  ?>
		<?php endif; ?>
	...
	<?php if ($this->contact->misc && $this->params->get('show_misc')) : ?>
		...
		<?php if ($this->params->get('presentation_style')=='plain'):?>
			<?php echo '<div class="contact-miscinfo-wrap"><h3>'. JText::_('COM_CONTACT_OTHER_INFORMATION').'</h3>'; ?>
		<?php endif; ?>
