		...
		jsAdvanceSearch = {
					action: {
						...
						calendar: function(type, id) {
							var inputField;
							if(type=='date'){
								inputField  = '<input class="inputbox" type="text" name="value'+id+'" id="value'+id+'" style="width:125px; margin-right:4px" value="" title="'+this.dateFormatDesc+'" readonly="true"/><img class="calendar" src="<?php echo rtrim( JURI::root(), "/"); ?>/components/com_community/assets/calendar.png" alt="calendar" id="value'+id+'_img" />';
							}else{
