	...
	<tr>
	    <td>
			...
			<tr>
				...
				<td class="value">
					<input id="to" name="to" class="inputbox fullwidth required text ac_input" type="text" autocomplete="off" value="<?php echo htmlspecialchars($data->to); ?>" />
				</td>
			</tr>
			...
			<tr class="noLabel">
				<td class="key"></td>
				<td class="value">
					<div class="hints"><?php echo JText::sprintf('COM_COMMUNITY_PM_LIMIT' , $maxSent); ?></div>
					<div class="hints"><?php echo JText::sprintf('COM_COMMUNITY_PM_LIMIT_REMAINING' , $totalSent , $maxSent); ?></div>
				</td>
			</tr>
			<?php
			}
			...
			<tr class="noLabel">
				...
				<td class="value">
					...
					<input id="submitBtn" class="button validateSubmit" name="submitBtn" type="submit" value="<?php echo JText::_('COM_COMMUNITY_SUBMIT_BUTTON'); ?>" />
				</td>
			</tr>
	    ...
	    <td width="150" valign="top">
			<div class="receiverList" style="text-align: center;">
		    	<select size="15" id="selections" name="selections[]" class="inputbox text">
		    	    <optgroup label="<?php echo JText::_('COM_COMMUNITY_FRIENDS_LIST');?>">
						<?php foreach ( $rows as $row ) : ?>
						<option value="<?php echo $row->getDisplayName(); ?>" id="<?php echo $row->id; ?>"><?php echo $row->getDisplayName(); ?></option>
						<?php endforeach; ?>
					</optgroup>
			    </select>
			    <input type="button" onclick="addFriendName();" class="button" value="<?php echo JText::_('COM_COMMUNITY_ADD_AS_RECIPIENT_BUTTON'); ?>" style="width: 140px;" />
			</div>
		</td>
	</tr>
</table>
