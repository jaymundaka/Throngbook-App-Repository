		    ...
		    <tr>
		        <td width="50">
		            <a href="<?php echo $row->url; ?>">
						<img width="32" src="<?php echo $row->groupAvatar; ?>" class="avatar" alt="<?php echo $this->escape($row->name); ?>"/>
					</a>
				</td>
				<td valign="top">
					<div>
					    <span id="msg-pending-<?php echo $row->groupid; ?>">
					    	...
					    	<?php echo JText::sprintf('COM_COMMUNITY_GROUPS_INVITED_NOTIFICATION' , $row->invitor->getDisplayName() ,  $row->name); ?>
