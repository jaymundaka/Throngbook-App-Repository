		...
		<div class="mini-profile-details">
			...
			<div class="mini-profile-details-action jsAbs jsFriendAction">
			    ...
			    <?php } else if( $handler->manageable() && !$guest->isMe && $guest->isAdmin ) { ?>
				    <span class="jsIcon1 icon-user">
				    	<a href="javascript:void(0);" onclick="jax.call('community','events,ajaxRemoveAdmin','<?php echo $guest->id;?>','<?php echo $eventid;?>');"><?php echo JText::_('COM_COMMUNITY_EVENTS_ADMIN_REVERT'); ?></a>
				    </span>
			    <?php
					}
				?>
