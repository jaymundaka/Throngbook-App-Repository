...
<div id="jsMenu">
	<div class="jsMenuLft">
		...
		?>
			...
			<div id="jsMenuNotif">
				<a href="javascript:joms.notifications.showWindow();" class="jsGlobalsNot jsIr" title="<?php echo JText::_( 'COM_COMMUNITY_NOTIFICATIONS_GLOBAL' );?>"><?php echo JText::_( 'COM_COMMUNITY_NOTIFICATIONS' );?></a>
				<?php if( $newEventInviteCount ) { ?>
				<span class="notifcount"><?php echo $newEventInviteCount; ?></span>
				<?php } ?>
			</div>
			<div id="jsMenuFriend">
				<a href="<?php echo CRoute::_( 'index.php?option=com_community&view=friends&task=pending' );?>" class="jsFriendsNot jsIr" title="<?php echo JText::_( 'COM_COMMUNITY_NOTIFICATIONS_INVITE_FRIENDS' );?>"><?php echo JText::_( 'COM_COMMUNITY_NOTIFICATIONS' );?></a>
				<?php if( $newFriendInviteCount ){ ?>
					<span class="notifcount"><?php echo $newFriendInviteCount; ?></span>
				<?php } ?>
			</div>
			<div id="jsMenuInbox">
				<a href="<?php echo CRoute::_( 'index.php?option=com_community&view=inbox' );?>" class="jsMesaggeNot jsIr" title="<?php echo JText::_( 'COM_COMMUNITY_NOTIFICATIONS_INBOX' );?>"><?php echo JText::_( 'COM_COMMUNITY_NOTIFICATIONS' );?></a>
				<?php if( $newMessageCount ){ ?>
				<span class="notifcount"><?php echo $newMessageCount; ?></span>
				<?php } ?>
			</div>
		</div>
	</div>
