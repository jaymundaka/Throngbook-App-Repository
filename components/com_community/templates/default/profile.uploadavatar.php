...
<div class="cModule avatarPreview leftside">	
	...
	<div class="imagePreview">
		<img id="large-profile-pic" src="<?php echo $user->getAvatar();?>" alt="<?php echo JText::_('COM_COMMUNITY_LARGE_PICTURE_DESCRIPTION'); ?>" title="<?php echo JText::_('COM_COMMUNITY_LARGE_PICTURE_DESCRIPTION'); ?>" />
	</div>
	<p>
